...
export default function Addproduct() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://reactinterviewtask.codetentaclestechnologies.in/api/api/add-product", {
                method: "POST",
                body: formData,
            });
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-3 text-sm border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                            />
                        ...
                        <div className='flex justify-between'>
                            ...
                            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 rounded-lg text-sm px-5 py-2.5">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
